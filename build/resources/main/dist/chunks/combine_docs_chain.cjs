 ...
 */
class StuffDocumentsChain extends server.BaseChain {
    get inputKeys() {
    ...
    static async deserialize(data) {
        ...
        return new StuffDocumentsChain({
            llmChain: await server.LLMChain.deserialize(data.llm_chain),
        });
    }
    serialize() {
        return {
 ...
 * @augments StuffDocumentsChainInput
 */
class MapReduceDocumentsChain extends server.BaseChain {
    get inputKeys() {
 ...
 */
class RefineDocumentsChain extends server.BaseChain {
    get defaultDocumentPrompt() {
        return new server.PromptTemplate({
    ...
    static async deserialize(data) {
        ...
        return new RefineDocumentsChain({
            llmChain: await server.LLMChain.deserialize(SerializedLLMChain),
            refineLLMChain: await server.LLMChain.deserialize(SerializedRefineDocumentChain),
        });
    }
    serialize() {
        return {
