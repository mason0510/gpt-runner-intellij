 ...
 */
class SequentialChain extends server.BaseChain {
    get inputKeys() {
    ...
    static async deserialize(data) {
        ...
        for (const serializedChain of serializedChains) {
            const deserializedChain = await server.BaseChain.deserialize(serializedChain);
 ...
 * ```
 */
class SimpleSequentialChain extends server.BaseChain {
    get inputKeys() {
